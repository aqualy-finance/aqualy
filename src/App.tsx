  ...
  return (
    ...
    >
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[22.313px] text-nowrap text-white">
        <p className="leading-[32px] whitespace-pre">Swappy</p>
      </div>
    </div>
  );
}
...
function Button() {
  return (
    <div
      className="bg-indigo-600 box-border content-stretch flex h-[44px] items-center justify-center px-[24px] py-[12px] relative rounded-[12px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] shrink-0"
      data-name="Button"
    >
...
function AppWalletConnector() {
  return (
    <div
      className="backdrop-blur-sm backdrop-filter content-stretch flex items-start relative rounded-[9999px] shrink-0"
...
function AppHeader({
  ...
  return (
    <div
      className="shrink-0 sticky top-0 w-full"
    ...
    >
      <div className="relative size-full">
        <div className="box-border content-stretch flex flex-col items-start px-[32px] py-[16px] relative w-full">
          <div
            className="absolute bg-gradient-to-b bottom-[-56px] from-[#030712] left-0 right-0 to-[rgba(3,7,18,0)] top-0"
            data-name="Gradient"
          />
          <Container3
            currentPage={currentPage}
  ...
  return (
    ...
    >
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-center text-gray-400 text-nowrap">
        <p className="leading-[16px] whitespace-pre">SUI</p>
      </div>
    </div>
  );
}
...
function Svg3() {
  return (
    <div
      className="absolute left-[72.04px] size-[20px] top-1/2 translate-y-[-50%]"
      data-name="SVG"
    >
      <svg
        className="block size-full"
...
function EthIcon() {
  return (
    <div
      className="max-w-[32px] relative rounded-[9999px] shrink-0 size-[32px]"
      data-name="ETH Icon"
    >
      <div
        aria-hidden="true"
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden rounded-[9999px]">
          <img
            alt=""
            className="absolute left-[3.13%] max-w-none size-[93.75%] top-[3.13%]"
            src={imgEthIcon}
          />
        </div>
      </div>
...
function Container11() {
  return (
    <div
      className="h-[32px] relative shrink-0 w-[100.04px]"
      data-name="Container"
    >
      <Margin1 />
      <Svg3 />
...
function Button1() {
  return (
    <div
      className="bg-gray-950 box-border content-stretch flex items-center overflow-clip relative rounded-[9999px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] shrink-0"
      data-name="Button"
    >
      <Container11 />
...
function Button2() {
  return (
    <div
      className="bg-gray-950 box-border content-stretch flex flex-col items-start p-[8px] relative rounded-[12px] shrink-0"
      data-name="Button"
    >
      <Svg4 />
    </div>
...
function Container17() {
  return (
    <div
      className="box-border content-stretch flex gap-[4px] h-[32px] items-center px-[12px] py-0 relative shrink-0"
      data-name="Container"
    >
      <Container16 />
      <Svg5 />
...
function Button3() {
  return (
    <div
      className="bg-indigo-600 content-stretch flex items-center relative rounded-[9999px] shrink-0"
      data-name="Button"
    >
      <Container17 />
    </div>
...
function AppSwapStandalone() {
  return (
    <div
      className="bg-gray-950 min-h-[569px] relative shrink-0 w-full"
      data-name="app-swap-standalone"
    >
      <div className="flex flex-col justify-center min-h-inherit relative size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-center min-h-inherit relative w-full px-[282px] px-[273px] py-[48px]">
          <Container22 />
        </div>
      </div>
    </div>
